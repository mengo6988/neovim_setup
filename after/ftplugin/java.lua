-- Commented out: requires mfussenegger/nvim-jdtls which is not installed —
-- every .java open errored with "module 'jdtls' not found". Re-enable together
-- with the nvim-java spec (lua/mengo/plugins/java.lua) after picking one stack.
