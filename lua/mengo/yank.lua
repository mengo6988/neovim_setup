...
-- Operator-pending: yank motion result with path
M.op_yank_with_path = function(type, path, label)
...
M.op_yank_absolute = function(type)
  M.op_yank_with_path(type, M.get_buffer_absolute(), 'absolute')
end

M.op_yank_relative = function(type)
  M.op_yank_with_path(type, M.get_buffer_cwd_relative(), 'relative')
end
